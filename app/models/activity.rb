class Activity
  ...
  property  :midsentence, String
  property  :target_name, String

  property  :endconnector, String
  property  :project_name, String
  
  property  :happened_at, DateTime
  
  property  :source_model, String
  property  :source_action, String
  
  timestamps :at
  
  # polymorphic target
  property  :target_id, Integer
  property  :target_class, String
  ...
  def self.create_from(model)
    ...
    model_name = model.class.to_s.snake_case
  ...
  def self.activity_for_screenshots(screenshot, is_new, is_updated, is_deleted) 
    ...
    previous = Activity.first(:conditions => {
